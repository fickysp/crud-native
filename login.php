                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Selamat Datang </br>Login</h1>
                                    </div>

                                    <?php
                                    if(isset($_GET['error'])){
                                        if($_GET['error'] == 'invalidUsername'){
                                            echo "<p>Username Ga ada bang!</p>";
                                        }elseif($_GET['error'] == 'invalidPassword'){
                                            echo "<p>Password Salah bang!</p>";
                                        }
                                    }
                                    ?>

                                    <form method="post" action="controller/action_login.php"
